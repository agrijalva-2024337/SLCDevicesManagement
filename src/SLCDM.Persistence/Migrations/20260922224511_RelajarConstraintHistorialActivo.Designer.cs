...
namespace SLCDM.Persistence.Migrations
{
    ...
    [Migration("20260922224511_RelajarConstraintHistorialActivo")]
    partial class RelajarConstraintHistorialActivo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.Asignacion", b =>
                {
                    ...
                    b.Property<string>("DocumentoPdfHash")
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.AsignacionDocumentoPdf", b =>
                {
                    ...
                    b.ToTable("asignacion_documento_pdf", (string)null);
                });
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleBaja", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_detalle_baja");
                    ...
                    b.Property<int>("IdAutorizadoPor")
                        .HasColumnType("int")
                        .HasColumnName("id_autorizado_por");
                    ...
                    b.HasIndex("IdAutorizadoPor");

                    b.HasIndex("IdMotivoBaja");

                    b.ToTable("detalle_baja", (string)null);
                });

            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleMantenimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("detalle_mantenimiento", (string)null);
                });

            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleTraslado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("detalle_traslado", (string)null);
                });
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.TipoMantenimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.UsuarioEmpresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.AsignacionDocumentoPdf", b =>
                {
                    b.HasOne("SLCDM.Domain.Entities.Asignacion", "Asignacion")
                        .WithOne()
                        .HasForeignKey("SLCDM.Domain.Entities.AsignacionDocumentoPdf", "IdAsignacion")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleBaja", b =>
                {
                    ...
                    b.HasOne("SLCDM.Domain.Entities.Usuario", "AutorizadoPor")
                        .WithMany()
                        .HasForeignKey("IdAutorizadoPor")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SLCDM.Domain.Entities.MotivoBaja", "MotivoBaja")
                        .WithMany()
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleMantenimiento", b =>
                {
                    ...
                    b.HasOne("SLCDM.Domain.Entities.TipoMantenimiento", "TipoMantenimiento")
                        .WithMany()
            ...
            modelBuilder.Entity("SLCDM.Domain.Entities.DetalleTraslado", b =>
                {
                    ...
                    b.HasOne("SLCDM.Domain.Entities.Ubicacion", "UbicacionDestino")
                        .WithMany()
                        .HasForeignKey("IdUbicacionDestino")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SLCDM.Domain.Entities.Ubicacion", "UbicacionOrigen")
                        .WithMany()
