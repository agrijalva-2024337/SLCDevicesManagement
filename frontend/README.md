...
| `/app/catalogos/:slug` | Áreas, proveedores, ubicaciones, países, y en Administración: usuarios, responsables, categorías, estados, tipos de asignación, redes Wi-Fi | Activa |
...
El sidebar agrupa **Administración** (usuarios, responsables, categorías, estados, tipos de asignación, redes Wi-Fi y bitácora) aparte de Catálogos. Usuarios y bitácora no se muestran a Consulta ni a Operador. Asignaciones, traslados, mantenimientos y bajas viven como pestañas de filtro en Activos.
